...
// Перезадать список для планировщика по текущему содержимому Memo1
procedure TForm5.Button4Click(Sender: TObject);
begin
  // Перезададим список для выбора значений в поле 'Задача' (2-я колонка, нумерация с 0)
  Form1.DBGrid1.Columns[3].PickList := Memo1.Lines;
  ShowMessage('Список названий задач для планировщика был перезадан');
end;

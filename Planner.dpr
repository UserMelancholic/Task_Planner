// Главный модуль программы "Планировщик задач".
...
begin
 ...
 // Cоздадим псевдоним (Alias) БД
  { Псевдоним (указатель на размещение БД) для доступа к базе данных 
   создается во время запуска программы и существует только во
  ...
  Application.CreateForm(TForm1, Form1);  // При создании Form1 создается таблица Tasks.db
  ...
  Form1.Table1.IndexName := 'indDateTime';
      // индекс с именем 'indDateTime' был создан при создании таблицы  в модуле Unit1
